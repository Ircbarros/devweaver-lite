# DevWeaver-Lite - OpenAI Context

> Use this file as the system message in ChatGPT custom instructions or the OpenAI API.
...
- Context budget: context_budget_remaining = 120000 (GPT-4o 128 000 total - 8 000 reserved output).
  For o3 or o4-mini: update to 192000 (200 000 total - 8 000 reserved).
- ChatGPT Custom Instructions: paste the contents of this file in the
  "What would you like ChatGPT to know about you?" field for persistent activation.
- OpenAI API: pass this file's content as the system message:
  messages=[{"role": "system", "content": <contents of this file>}, ...]
- Assistants API: paste this file as the assistant Instructions field.
...
- L3 references: rely on model knowledge (no filesystem access in ChatGPT/OpenAI web).
