# DevWeaver-Lite - Kimi Context

> Use this file as the system message for Kimi (Moonshot AI).
> Paste as system message in Kimi API or Kimi chat custom instructions.
...
- Context budget: context_budget_remaining = 120000 (Kimi 128 000 total - 8 000 reserved output).
- Kimi API (Moonshot AI): pass this file's content as the system message:
  messages=[{"role": "system", "content": <contents of this file>}, ...]
- Kimi Chat: paste this file's content into custom instructions if available,
  or start each conversation with the contents of this file.
- Context window: Kimi supports up to 128K tokens. Kimi long-context models
  (moonshot-v1-128k) support the full context_budget_remaining = 120000.
...
- L3 references: rely on model knowledge (no filesystem access in Kimi).
