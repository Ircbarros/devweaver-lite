# DevWeaver-Lite - Mistral Context

> Use this file as the system message for Mistral AI (La Plateforme or Le Chat).
...
- Context budget: context_budget_remaining = 120000 (Mistral 128 000 total - 8 000 reserved output).
- La Plateforme API: pass this file's content as the system message.
  Use model mistral-large-latest or mistral-medium for best results:
  messages=[{"role": "system", "content": <contents of this file>}, ...]
- Le Chat: paste this file's content into custom instructions or the system message field.
- Context window: Mistral Large supports 128K tokens. context_budget_remaining = 120000.
- Mistral function calling: configure MCP tools as Mistral function definitions if using
  the API with tool support.
...
- L3 references: rely on model knowledge (no filesystem access in Mistral).
